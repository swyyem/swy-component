...
import type { KeyType, ProTableFormValidateType, ProRecordDataType, ProTableProviderProps, ProTableEditProps, ProTableFormInvalidFieldsType, ProTableGetRowKey, ProBaseTableInstance, ProBaseTableProps } from './table.types';
...
export type ProTableEditInstance<T extends ProComponentObject> = Omit<ProBaseTableInstance<T>, 'tableBodyRef' | 'getRealDataHasKey'> & {
