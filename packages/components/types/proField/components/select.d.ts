...
import type { ProSchemaValueEnumType, ProFieldRequestData, ProSelectProps } from '../index.type';
import type { TextSpecifiledProps } from './text/type';
declare const _default: import("vue").DefineComponent<import("vue").ExtractPropTypes<{
    fieldProps: {
        type: PropType<Partial<ProSelectProps>>;
        required: true;
    };
    textProps: {
    ...
    modelValue: {
        type: PropType<string | number | boolean | object | null | Array<string | number | boolean | object | null>>;
    };
    emptyText: {
        type: PropType<string>;
    };
