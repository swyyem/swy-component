...
type TagValue = any;
export type ProInputTagProps = Partial<Pick<InputProps, 'placeholder' | 'clearable' | 'disabled'>> & {
    /** 组件的值 */
    modelValue?: TagValue[];
    /** 下拉面板宽度 */
    contentWidth?: number;
...
export type ProInputTagDropdownProps = Pick<ProInputTagProps, 'contentWidth' | 'popperClass' | 'fitInputWidth'> & {
    tagRef?: HTMLElement;
};
